...
<img src="../../assets/post/images/kernel1.png" alt="kernel1" style="zoom:67%;" />
...
<img src="../../assets/post/images/kernel2.png" alt="kernel2" style="zoom:67%;" />

选择 seu，系统正常启动。

<img src="../../assets/post/images/kernel3.png" alt="kernel3" style="zoom:67%;" />
...
<img src="../../assets/post/images/kernel4.png" alt="kernel4" style="zoom:67%;" />
...
<img src="../../assets/post/images/kernel5.png" alt="kernel5" style="zoom: 67%;" />
...
<img src="../../assets/post/images/kernel6.png" alt="kernel6" style="zoom:67%;" />

创建 4 个测试文件

<img src="../../assets/post/images/kernel7.png" alt="kernel7" style="zoom:67%;" />
...
<img src="../../assets/post/images/kernel8.png" alt="kernel8" style="zoom:67%;" />

测试 `./hideInit`

<img src="../../assets/post/images/kernel9.png" alt="kernel9" style="zoom:67%;" />

没有成功。

进入 root 权限重新测试

<img src="../../assets/post/images/kernel10.png" alt="kernel10" style="zoom:67%;" />

看到 1 号进程成功屏蔽

测试 `./recoverInit`

<img src="../../assets/post/images/kernel11.png" alt="kernel11" style="zoom:67%;" />

init 又回来了

测试 `./hideRootInit`

<img src="../../assets/post/images/kernel12.png" alt="kernel12" style="zoom:67%;" />

看到 root 的 init 进程成功屏蔽

测试 `./hideRoot`

<img src="../../assets/post/images/kernel13.png" alt="kernel13" style="zoom:67%;" />

<img src="../../assets/post/images/kernel14.png" alt="kernel14" style="zoom:67%;" />
...
<img src="../../assets/post/images/kernel15.png" alt="kernel15" style="zoom:67%;" />
