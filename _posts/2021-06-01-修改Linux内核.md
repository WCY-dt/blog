...
<img src="./../assets/post/images/23gYdGDXbMnazB8.png" alt="image-20210719100533082" style="zoom:67%;" />
...
<img src="./../assets/post/images/HaDr45hP8A9B1oe.png" alt="image-20210719102455338" style="zoom:67%;" />

选择 seu，系统正常启动。

<img src="./../assets/post/images/bIZsvxrow5zaXqM.png" alt="image-20210719142803971" style="zoom:67%;" />
...
<img src="./../assets/post/images/5gULVmAFlkNGCey.png" alt="image-20210721191655445" style="zoom:67%;" />
...
<img src="./../assets/post/images/xPfb76snF32umSg.png" alt="image-20210721191946278" style="zoom: 67%;" />
...
<img src="./../assets/post/images/CGlUKn8f17Akobx.png" alt="image-20210723002556399" style="zoom:67%;" />

创建 4 个测试文件

<img src="./../assets/post/images/NyRDlOZ7f8YFxTr.png" alt="image-20210723005835398" style="zoom:67%;" />
...
<img src="./../assets/post/images/mzwTndEc3Nu5lsg.png" alt="image-20210723012202234" style="zoom:67%;" />

测试 `./hideInit`

<img src="./../assets/post/images/kSiLh4PvY7cHfKm.png" alt="image-20210723012222790" style="zoom:67%;" />

没有成功。

进入 root 权限重新测试

<img src="./../assets/post/images/YV3WOUSZK84eksl.png" alt="image-20210723011848018" style="zoom:67%;" />

看到 1 号进程成功屏蔽

测试 `./recoverInit`

<img src="./../assets/post/images/image-20210723012134601.png" alt="image-20210723012134601" style="zoom:67%;" />

init 又回来了

测试 `./hideRootInit`

<img src="./../assets/post/images/image-20210723032656927.png" alt="image-20210723032656927" style="zoom:67%;" />

看到 root 的 init 进程成功屏蔽

测试 `./hideRoot`

<img src="./../assets/post/images/ahwtXxKRVnEZJul.png" alt="image-20210723025539500" style="zoom:67%;" />

<img src="./../assets/post/images/9kXnWcP5S1bqJhf.png" alt="image-20210723033122281" style="zoom:67%;" />
...
<img src="./../assets/post/images/image-20210723034549262.png" alt="image-20210723034549262" style="zoom:67%;" />
