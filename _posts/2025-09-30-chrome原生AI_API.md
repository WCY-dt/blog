...
summary:    "模型搬进浏览器后，翻译和摘要可以直接在本地完成。用可运行的 JavaScript 示例，尝试 Chrome 不依赖远程接口的 AI 功能。"
---
...
{% iframe frontend_ai is_embedded=true %}
...
{% iframe frontend_ai_language_detect %}
...
{% iframe frontend_ai_language_model %}
