...
summary:    "《深入 Redis 源码》第 5 篇：有了磁盘备份，主机宕机后仍可能无法服务。看 Redis 如何让副本接管请求，并把单机装不下的数据分给多个节点。"
series:     深入 Redis 源码
series_index: 5
---
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/replication.c#L2997 %}
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/replication.c#L2921 %}
...
这通过每秒运行一次的 `replicationCron` 函数来实现：

{% github_code_btn https://github.com/redis/redis/blob/7.4/src/replication.c#L3704 %}
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/replication.c#L3953 %}
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/replication.c#L834 %}
...
- 如果支持无盘复制，则调用了 `rdbSaveToSlavesSockets` 函数来将数据通过 TLS 管道发送给从服务器。

{% github_code_btn https://github.com/redis/redis/blob/7.4/src/rdb.c#L3851 %}
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L469 %}
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L5449 %}
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L5358 %}
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L2377 %}
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L3095 %}
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L4516 %}
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L4951 %}
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L4927 %}
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L4670 %}
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L5358 %}
  ...
  - 等待开始的函数：
    ...
    {% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L5087 %}
...
<div markdown="1">
  ...
  - 选择从服务器的函数：
    ...
    {% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L5120 %}
    ...
    {% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L5041 %}
    ...
    {% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L5013 %}
...
<div markdown="1">
  ...
  - 发送 SLAVEOF NO ONE 的函数：

    {% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L5139 %}
  ...
  - 等待提升的函数：
    ...
    {% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L5167 %}
...
<div markdown="1">
  ...
  - 重配置从服务器的函数：
    ...
    {% github_code_btn https://github.com/redis/redis/blob/7.4/src/sentinel.c#L5239 %}
...
{% github_code_btn https://github.com/redis/redis/blob/7.4/src/cluster.h#L43 %}
