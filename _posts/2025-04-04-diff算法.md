...
categories: 算法
tags:       diff myers
summary:    "《算法笔记》第 2 篇：两个文件之间，最少要改几处？把差异比较画成网格上的寻路问题，看 Myers 算法如何避开大面积的无用计算。"
series:     算法笔记
series_index: 2
---
...
<img src="/assets/post/images/diff3.svg" alt="myers-kd坐标系" style="width:min(500px,100%)">
...
<img src="/assets/post/images/diff4.svg" alt="myers-执行过程1" style="width:min(500px,100%)">

<img src="/assets/post/images/diff5.svg" alt="myers-执行过程2" style="width:min(350px,100%)">
