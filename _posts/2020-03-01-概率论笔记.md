...
- ***二维正态分布***
  ...
  $$\begin{aligned}&f\left(x,y\right)\\=&\frac{1}{2\pi {\sigma}_1{\sigma}_2\sqrt{1-r^2} }\\&\exp{\left[-\frac{1}{2\left(1-r^2\right)}\left(\frac{ {\left(x-{\mu}_1\right)}^2}{ {\sigma}_{1}^{2} }-2r\frac{\left(x-\mu_1\right)\left(y-\mu_2\right)}{\sigma_1\sigma_2}+\frac{ {\left(y-{\mu}_2\right)}^2}{ {\sigma}_{2}^{2} }\right)\right]}\end{aligned}$$
...
- ***定义***
  ...
  - 连续型随机变量
    ...
    $$\begin{aligned}&F_{Y\mid X}{\left(y\mid x\right)}\\=&P\left(Y\leq y\mid X=x\right)\\=&\frac{P\left(X=x,Y\leq y\right)}{P\left(X=x\right)}\\=&\lim_\limits{\alpha \rightarrow0}{\frac{F\left(x,y\right)-F\left(x-\alpha,y\right)}{F\left(x,+\infty\right)-F\left(x-\alpha,+\infty\right)} }\end{aligned}$$
...
- ***二维连续型随机变量***
  ...
  - 卷积公式
    ...
    $$\begin{aligned}&f_{X}\cdot f_{Y}\\=&f_{Z}{\left(z\right)}\\=&\int_{-\infty}^{+\infty}{f_{X}{\left(x\right)}f_{Y}{\left(z-x\right)\mathrm{d}x} }\\=&\int_{-\infty}^{+\infty}{f_{X}{\left(z-y\right)}f_{Y}{\left(y\right)\mathrm{d}y} }\end{aligned}$$
...
- ***两个正态总体***
  ...
  $$\begin{aligned}&\overline{X}=\frac{1}{m}\sum_\limits{i=1}^{m}{X_i}\\&S_{1m}^2=\frac{1}{m-1}\sum_{i=1}^{m}{ {\left(X_i-\overline{X}\right)}^2}\\&\overline{Y}=\frac{1}{n}\sum_\limits{i=1}^{n}{Y_i}\\&S_{2n}^2=\frac{1}{n-1}\sum_{i=1}^{n}{ {\left(Y_i-\overline{Y}\right)}^2}\end{aligned}$$
