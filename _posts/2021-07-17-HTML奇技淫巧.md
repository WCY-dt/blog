...
<form><fieldset><legend>这篇文章里有什么</legend><input type="radio" id="1" name="whatinthe article"><label for="1">html</label><br/><input type="radio" id="2" name="whatinthe article"><label for="2"><a href="tel:120">回字的四种写法</a></label><br/><input type="radio" id="3" name="whatinthe article"><label for="3"><details><summary>不要瞎点里面的链接</summary><p>嘉然</p></details></label></fieldset></form>
...
> **效果**
>
> <form id="output-example" oninput="result.value=parseInt(a.value) + parseInt(b.value)"><input name="a" type="range" min="0" max="100" value="25"> +  <input name="b" type="number" value="1"> = <output name="result" for="a+b"></output></form>
